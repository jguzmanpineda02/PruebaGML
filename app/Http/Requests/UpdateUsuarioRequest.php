...
class UpdateUsuarioRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'cedula' => 'required|numeric|integer|min:1000000|max:9999999999|unique:usuarios,cedula,'.$this->id,
            'pais' => 'required',
            'email' => 'required|email|max:150|unique:usuarios,email,' .$this->id,
    ...
    public function messages()
    {
        return [
            ...
            'cedula.unique' => 'La cedula ya está regitrada en el sistema.',
